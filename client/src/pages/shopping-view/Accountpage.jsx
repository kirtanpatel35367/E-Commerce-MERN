  ...
  return (
    <div className='flex flex-col'>
      <div className='relative h-[400px] w-full overflow-hidden cursor-pointer bg-[#682b0dcb] flex items-center justify-center'>
        ...
        <p className='text-white  flex items-center text-center justify-center font-common text-6xl py-2'>Your style, your choices, your store crafted just for you. <br />Shop with confidence, live with elegance.</p>
      </div>
